...
public class ChatUtil extends Util {
    ...
    public static void log(String message) {
        thePlayer.addChatMessage(new ChatComponentText("§bSleek §7» §f" + message));
    }

    public static void logNoPrefix(String message) {
        thePlayer.addChatMessage(new ChatComponentText("§f" + message));
    }

    public static void logCheater(String message) {
        thePlayer.addChatMessage(new ChatComponentText("§7[§b§lAC§7] §f" + message));
    }
