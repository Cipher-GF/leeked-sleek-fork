...
public class AttackEffect extends Module {
    ...
    public NumberValue<Integer> modenum = new NumberValue("Amount", this,1.0, 1.0, 20.0, 1.0);
    ...
    public NumberValue<Integer> critnum = new NumberValue("Amount", this,1.0, 1.0, 20.0, 1.0, crit);
