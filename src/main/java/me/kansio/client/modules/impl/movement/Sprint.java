...
public class Sprint extends Module {
    ...
    public void onPacket(PacketEvent event) {
        if (event.getPacketDirection().name().equalsIgnoreCase("INBOUND") && !(event.getPacket() instanceof C03PacketPlayer)) if (keepSprint.getValue() && event.getPacket() instanceof C0BPacketEntityAction) {
