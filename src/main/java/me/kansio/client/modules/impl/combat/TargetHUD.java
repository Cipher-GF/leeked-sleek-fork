...
public class TargetHUD extends Util {
    ...
    public static void draw(RenderOverlayEvent event, EntityLivingBase target) {
        ...
        RenderUtils.drawRect(155, 390, (float) (target.getHealth() * 6.9), 15,  new Color(0, 255, 0, 255).getRGB());
        RenderUtils.drawRect(155, 410, (float) (target.getTotalArmorValue() * 6.9), 15,  new Color(0, 255, 255, 255).getRGB());
        ...
        mc.fontRendererObj.drawStringWithShadow("Armor: " + target.getTotalArmorValue(), 160, 413, -1);
    }
}
