...
import today.sleek.client.modules.impl.visuals.Perspective;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw() + (Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw() - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch() + (Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch() - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                float f1 = Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw();
                float f2 = Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch();
                ...
                GlStateManager.rotate(Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
                GlStateManager.rotate(f1 - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        } else {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f6 = Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw() + (Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw() - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraYaw()) * partialTicks + 180.0F;
                float f7 = Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch() + (Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch() - Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        if (this.mc.inGameHasFocus && flag && (Sleek.getInstance().getModuleManager() != null && Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class) != null && Sleek.getInstance().getModuleManager().getModuleByClass(Perspective.class).overrideMouse())) {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Sleek.getInstance().getEventBus().post(new Render3DEvent(partialTicks));
