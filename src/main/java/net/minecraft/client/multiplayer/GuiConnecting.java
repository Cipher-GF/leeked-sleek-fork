...
import today.sleek.client.modules.impl.visuals.Playtime;
...
//        System.out.println("Connecting to " + p_i1181_3_.serverIP + ":" + p_i1181_3_);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120 + 12, 203, 20,I18n.format("gui.cancel", new Object[0])));
    }
