...
public class GuiControls extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 155, this.height - 29, 80, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.buttonReset = new GuiButton(201, this.width / 2 - 155 + 160, this.height - 29, 80, 20, I18n.format("controls.resetAll", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Fonts.Verdana.drawCenteredString(this.screenTitle, this.width / 2, 8, 16777215);
        boolean flag = true;
