...
public class Radar extends Module {
    ...
    public void onRenderOverlay(RenderOverlayEvent event) {
        ...
        for (Entity en : mc.theWorld.loadedEntityList) {
            ...
            RenderUtils.draw2DPolygon(maX / 2 + 3 - x_shift, miY + 52 - y_shift, 3f, 4, Sleek.getInstance().getFriendManager().isFriend(en.getName()) ? Color.cyan.getRGB() : Color.red.getRGB());
        }
