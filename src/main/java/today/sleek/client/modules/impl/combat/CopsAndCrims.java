...
public class CopsAndCrims extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        targets = targets.stream().filter(e -> e.getDistanceToEntity(mc.thePlayer) < range.getValue() && e != mc.thePlayer && e.canEntityBeSeen(mc.thePlayer) && !e.isInvisible() && !e.isDead && !Sleek.getInstance().getFriendManager().isFriend(e.getName())).collect(Collectors.toList());
