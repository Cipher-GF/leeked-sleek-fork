...
public class ProtectionUtil {
    ...
    public static boolean gsudfgyfuisadgfdsouaiygsdeugdsoygfsdhohiusdfhuisdghiudgshiufssfdhiushudsdfuhfdshufdshuisfdhsfdhiusfdhuifsdhuifsdhuisfdhiufsdhiufsdhiusfdhuisfdhuifsdhuifsdhuifsdhiufsdiuhfsdhiufdshuisfdhui() {
        ...
        try {
            CodeSource jijosdfgijsofgdjifgsosjgfipsjfgiosjigfodjgfidfgjidogfsjidosfgjdiofsgdijosfgdjiosgfdijosgfdijsfgdjisfdjiogsfgjdiopfgsjipsgfjiopsfgjidofgjiodjfdgiossjgiofdjiopgijosdfjigosdijfogisdfjgoisjdfjiogsjidofgjiosjiodfgjiosdijgjidof = Sleek.class.getProtectionDomain().getCodeSource();
    ...
    public static String huisdfhufisdhfiusdhifsudfsihdusdiuhsfdiusfdhuisdfiuhsdfhisfdhiufsdhui() {
        try {
            CodeSource jisiojfdsjiodfjidffjisodsfjoidfsjdiosfdijofsdjiofsdjiosdfjoisfdijosdfjiosdfiojfsdjiosdfijosdfjiofsd = Sleek.class.getProtectionDomain().getCodeSource();
